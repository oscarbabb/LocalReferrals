...
export default function ServiceCard({ category, providerCount = 0, showSubcategories = true }: ServiceCardProps) {
  ...
  return (
    <>
      ...
      {/* Subcategories dropdown - simple approach */}
      {showSubcategories && subcategories.length > 0 && isExpanded && (
        <div className="absolute top-full left-0 right-0 z-[999] bg-white rounded-lg shadow-xl border border-gray-200 mt-2 overflow-hidden">
          <div className="p-4">
